...
exercise: use the elev raster and write two local operations that will return a raster where all the values are 1. Confirm this using a logical statement (> < =)
```{r}
